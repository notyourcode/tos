...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named OutlookContactSync


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NotYourCode.dev
...
- By email: 
  ...
  ![email address](../../../assets/email-med.svg)